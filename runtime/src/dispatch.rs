...
/// method body. Returns `Value::NULL` if no method applies (a MethodError in
/// Julia). The caller must keep `args` rooted across this call.
pub fn invoke(func: u32, args: &[Value]) -> Value {
