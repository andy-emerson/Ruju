...
| **AOT thin slice** | compilation | M | W3–W5 | build-time pipeline (fixture may be hand-transcribed) | ~~stage 1 done 2026-07-09~~ — **GO**: 401.8× interpreter, 0.95× native, both call paths, two-module linking proven (`implementation.md`, AOT section). Stage 2 (allocating function → shadow-stack freeze) remains |
